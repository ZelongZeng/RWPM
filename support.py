    ...
    def compute_anomaly_scores(
        ...
        for x, y in tqdm(loader, desc="Dataset Iteration"):
            ...
            if global_cache.CALIBRATION:
                ...
                for i in range(4):
                    for j in range(4):
                        f_map_sub = score[size_p_h*i:size_p_h*(i+1),size_p_w*j:size_p_w*(j+1)]
                        part_list.append(f_map_sub)
                
                part_list[14] = ((part_list[13][:,-1]/part_list[14][:,0]).mean()) * part_list[14]
                part_list[15] = ((part_list[14][:,-1]/part_list[15][:,0]).mean()) * part_list[15]
                part_list[12] = ((part_list[13][:,0]/part_list[12][:,-1]).mean()) * part_list[12]
                part_list[9]  = ((part_list[13][0,:]/part_list[9][-1,:]).mean()) * part_list[9]

                part_list[10] = ((part_list[9][:,-1]/part_list[10][:,0]).mean()) * part_list[10]
                part_list[11] = ((part_list[10][:,-1]/part_list[11][:,0]).mean()) * part_list[11]
                part_list[8] = ((part_list[9][:,0]/part_list[8][:,-1]).mean()) * part_list[8]
                part_list[5]  = ((part_list[9][0,:]/part_list[5][-1,:]).mean()) * part_list[5]

                part_list[6] = ((part_list[5][:,-1]/part_list[6][:,0]).mean()) * part_list[6]
                part_list[7] = ((part_list[6][:,-1]/part_list[7][:,0]).mean()) * part_list[7]
                part_list[4] = ((part_list[5][:,0]/part_list[4][:,-1]).mean()) * part_list[4]
                part_list[1]  = ((part_list[5][0,:]/part_list[1][-1,:]).mean()) * part_list[1]

                part_list[2] = ((part_list[1][:,-1]/part_list[2][:,0]).mean()) * part_list[2]
                part_list[3] = ((part_list[2][:,-1]/part_list[3][:,0]).mean()) * part_list[3]
                part_list[0] = ((part_list[1][:,0]/part_list[0][:,-1]).mean()) * part_list[0]

                score = torch.cat((
                    torch.cat((part_list[0],part_list[1],part_list[2],part_list[3]),1), 
                    torch.cat((part_list[4],part_list[5],part_list[6],part_list[7]),1),
                    torch.cat((part_list[8],part_list[9],part_list[10],part_list[11]),1),
                    torch.cat((part_list[12],part_list[13],part_list[14],part_list[15]),1)), 0)
