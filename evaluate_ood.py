...
parser.add_argument('--TT', type=int, default=20,
                    help="Iteration times of random walk")

parser.add_argument('--temperture', type=float, default=0.01,
                    help="SOFTMAX temperture")

parser.add_argument('--n_patrion', type=int, default=2,
                    help="Number of the patrion")

parser.add_argument('--RWPM', type=int, default=1,
                    help="Use RWPM")

parser.add_argument('--CALIBRATION', type=int, default=0,
                    help="Use carlibration")
...
global_cache.alpha = args.alpha
global_cache.TT = args.TT
global_cache.temperture = args.temperture
global_cache.n_patrion = args.n_patrion
global_cache.RWPM = args.RWPM
global_cache.CALIBRATION = args.CALIBRATION
